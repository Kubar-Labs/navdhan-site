...
import { ApplyMaintenance } from "@/src/components/apply/ApplyMaintenance";
import { getApplyIntakeMode } from "@/src/lib/apply/intake-mode";
...
export default async function ApplyPage({ params }: ApplyPageProps) {
  ...
  if (getApplyIntakeMode() === "paused") {
    return (
      <Container className="py-12 md:py-20">
        <ApplyMaintenance locale={locale} />
      </Container>
    );
  }
